...
class SensorsGroupSubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  #test "should create sensors_group_subscription" do
    #assert_difference('SensorsGroupSubscription.count',1) do
      #post sensors_group_subscriptions_url, params: { sensors_group_subscription: { sensor_id: @sensors_group_subscription.sensor_id, sensor_group_id: @sensors_group_subscription.sensor_group_id } }
    #end
  ...
  #test "should update sensors_group_subscription" do
    #patch sensors_group_subscription_url(@sensors_group_subscription), params: { sensors_group_subscription: { sensor_id: @sensors_group_subscription.sensor_id, sensor_group_id: @sensors_group_subscription.sensor_group_id } }
